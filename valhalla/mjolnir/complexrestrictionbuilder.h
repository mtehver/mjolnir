...
class ComplexRestrictionBuilder {
 public:
   ...
   *
   */
  void set_from_id(const uint64_t from_id);
   ...
   *
   */
  void set_to_id(const uint64_t to_id);
   ...
   *
   */
  void set_via_list(const std::vector<uint64_t>& via_list);
